        ...
        <>
            <div className="card-base mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {cars.map((car) => (
                        <div key={car.id} className="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-lg
                            ...
                            <div className="p-6">
                                ...
                                <div className="mt-4 flex justify-between items-center">
                                    <Link href={`/cars/${car.id}`} className="inline-flex items-center text-sm font-medium text-blue-600 dark:text-blue-400
